...
public class CafeKeyword2Activity extends BasicActivity {
    ...
    @BindView(R.id.cafe2_group_type)
    RadioGroup radioTypeGroup;
    @BindView(R.id.cafe2_dog)
    RadioButton radioDog;
    @BindView(R.id.cafe2_cat)
    RadioButton radioCat;

    // 크기 결정
    @BindView(R.id.cafe2_group_size)
    RadioGroup radioSizeGroup;
    @BindView(R.id.cafe2_radio_small)
    RadioButton radioSmallSize;
    @BindView(R.id.cafe2_radio_big)
    RadioButton radioBigSize;
    @BindView(R.id.cafe2_radio_all)
    RadioButton radioAll;

    // 강아지 - 물품 체크박스
    @BindView(R.id.cafe2_d_fense)
    CheckBox checkFense;
    @BindView(R.id.cafe2_d_small)
    CheckBox checkSmall;
    @BindView(R.id.cafe2_d_big)
    CheckBox checkBig;
    @BindView(R.id.cafe2_d_toliet)
    CheckBox checkToliet;
    @BindView(R.id.cafe2_d_room)
    CheckBox checkDogRoom;

    // 고양이 - 물품 체크박스
    @BindView(R.id.cafe2_c_cage)
    CheckBox checkCage;
    @BindView(R.id.cafe2_c_sand)
    CheckBox checkSand;
    @BindView(R.id.cafe2_c_tower)
    CheckBox checkTower;
    @BindView(R.id.cafe2_c_room)
    CheckBox checkCatRoom;

    // 음식 여부
    @BindView(R.id.cafe2_group_food)
    RadioGroup radioFoodGroup;
    @BindView(R.id.cafe2_yes)
    RadioButton foodYes;
    @BindView(R.id.cafe2_no)
    RadioButton foodNo;
    ...
    RadioGroup.OnCheckedChangeListener radioGroupListener = new RadioGroup.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup radioGroup, int i) {
            switch (i) {
                ...
                /**  1= small 2 = big  3 = 모두 가능 **/
                case R.id.cafe2_radio_small:
                    animalSize = 1;
                    break;
                case R.id.cafe2_radio_big:
                    animalSize = 2;
                    break;
                case R.id.cafe2_radio_all:
                    animalSize = 3;
                    break;
            }
        }
