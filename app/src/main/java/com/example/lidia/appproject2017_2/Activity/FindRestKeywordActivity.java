...
public class FindRestKeywordActivity extends BasicActivity {
    @BindView(R.id.find_r_key_container_size)
    LinearLayout sizeLayout;

    @BindView(R.id.find_r_key_container_thing)
    LinearLayout thingLayout;

    @BindView(R.id.find_r_key_container_food)
    LinearLayout foodLayout;

    @BindView(R.id.find_r_key_dog_thing_layout)
    RelativeLayout dogThingLayout;

    @BindView(R.id.find_r_key_cat_thing_layout)
    RelativeLayout catThingLayout;

    @BindView(R.id.find_r_key_back)
    ImageView back;

    @BindView(R.id.find_r_key_done)
    ImageView done;

    @BindView(R.id.find_r_key_group_type)
    RadioGroup petTypeGroup;
    @BindView(R.id.find_r_key_cat_radio)
    RadioButton radioCat;
    @BindView(R.id.find_r_key_dog_radio)
    RadioButton radioDog;

    @BindView(R.id.find_r_key_group_size)
    RadioGroup sizeGroup;
    @BindView(R.id.find_r_key_small)
    RadioButton radioSmallMediumSize;
    @BindView(R.id.find_r_key_big)
    RadioButton radioBigSize;

    @BindView(R.id.find_r_key_dog_fense)
    CheckBox dogFense;
    @BindView(R.id.find_r_key_dog_s_cage)
    CheckBox dogSmallCage;
    @BindView(R.id.find_r_key_dog_b_cage)
    CheckBox dogBigCage;
    @BindView(R.id.find_r_key_dog_toliet)
    CheckBox dogToliet;
    @BindView(R.id.find_r_key_dog_room)
    CheckBox dogRoom;


    @BindView(R.id.find_r_key_cat_cage)
    CheckBox catCage;
    @BindView(R.id.find_r_key_cat_tower)
    CheckBox catTower;
    @BindView(R.id.find_r_key_cat_sand)
    CheckBox catSandToliet;
    @BindView(R.id.find_r_key_cat_room)
    CheckBox catRoom;

    @BindView(R.id.find_r_key_group_food)
    RadioGroup foodGroup;
    @BindView(R.id.find_r_key_yes)
    RadioButton foodYes;
    @BindView(R.id.find_r_key_no)
    RadioButton foodNo;
    ...
    private int isFood = 100;   // 1 = yes  2= no
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.find_r_key_cat_radio:
                    ...
                    break;
                case R.id.find_r_key_dog_radio:
                    ...
                    foodLayout.setVisibility(View.VISIBLE);
                    break;
                case R.id.find_r_key_back:
                    finish();
                    overridePendingTransition(0, 0);
                    break;
                case R.id.find_r_key_done:
                    showProgressDialog();
                    ...
                    if(!checkVaild(thing,isFood)){
                        ...
                        Intent intent = new Intent(FindRestKeywordActivity.this, ResultRestActivity.class);
    ...
    RadioGroup.OnCheckedChangeListener radioGroupListener = new RadioGroup.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup radioGroup, int i) {
            switch (i){
                ...
                case R.id.find_r_key_small:
                    petSize = 1;
                    break;
                case R.id.find_r_key_big:
                    petSize = 2;
                    break;

                /**  1= 제공 2 = 제공안함 **/
                case R.id.find_r_key_yes:
                    isFood= 1;
                    break;
                case R.id.find_r_key_no:
                    isFood= 2;
                    break;
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_rest_keyword);
